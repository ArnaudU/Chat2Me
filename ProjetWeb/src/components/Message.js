...
import coeur_icon from '../assets/img/coeur.png';
import msg_icon from '../assets/img/message.png';
import retweet_icon from '../assets/img/retweet.png'
    ...
    function MessageBody() {
        return (
            <section>
                ...
                <ul>
                    <li>
                        <img src={msg_icon} alt="Commentaire" />
                    </li>
                    <li id='retweet' className='compteur'>
                        <img src={retweet_icon} alt="Rt" onClick={rtOnClick} />
                        <span>{rt}</span>
