...
router.post("/api/:user", user.createUser)// permet de creer un compte
router.post("/api/:user/login", user.login) //permet de se connecter
router.delete("/api/:user/userid/logout", user.logout) //permet de se deconnecter
...
router.post("/apimsg/user/userid/messages", message.createMessage)//poster un message
